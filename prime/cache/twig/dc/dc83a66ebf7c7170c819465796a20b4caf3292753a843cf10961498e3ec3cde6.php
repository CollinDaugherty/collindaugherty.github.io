...
class __TwigTemplate_81afe5490a2b14028c1972e937af94768b94463864ad6921ef7facc745b68baa extends Twig_Template
{
...
<ul class=\"pagination\">
    ";
            ...
            if ($this->getAttribute(($context["pagination"] ?? null), "hasPrev", array())) {
                // line 8
                echo "        ";
                $context["url"] = (($context["base_url"] ?? null) . twig_replace_filter(($this->getAttribute(($context["pagination"] ?? null), "params", array()) . $this->getAttribute(($context["pagination"] ?? null), "prevUrl", array())), array("//" => "/")));
                // line 9
...
$context["paginate"], "isInDelta", array())) {
                    // line 19
                    echo "            ";
                    $context["url"] = (($context["base_url"] ?? null) . twig_replace_filter(($this->getAttribute(($context["pagination"] ?? null), "params", array()) . $this->getAttribute($context["paginate"], "url", array())), array("//" => "/")));
                    // line 20
                    echo "            <li><a href=\"";
                    echo ($context["url"] ?? null);
                    echo "\">";
...
$context["paginate"], "isDeltaBorder", array())) {
    ...
    ";
            ...
            if ($this->getAttribute(($context["pagination"] ?? null), "hasNext", array())) {
                // line 27
                echo "        ";
                $context["url"] = (($context["base_url"] ?? null) . twig_replace_filter(($this->getAttribute(($context["pagination"] ?? null), "params", array()) . $this->getAttribute(($context["pagination"] ?? null), "nextUrl", array())), array("//" => "/")));
                // line 28
...
{% endif %}", "partials/pagination.html.twig", "/Users/collin/Sites/website2/user/themes/prime/templates/partials/pagination.html.twig");
    }
}
